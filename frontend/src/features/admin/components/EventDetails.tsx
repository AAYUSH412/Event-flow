...
import { Calendar, MapPin, User, Tag, School, Users } from "lucide-react";
...
export default function EventDetails({ event, regStats }: EventDetailsProps) {
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      <div className="flex flex-wrap gap-4 mb-4">
        ...
        <div className="flex items-center text-gray-600">
          <User className="h-5 w-5 mr-1.5 text-indigo-500" />
